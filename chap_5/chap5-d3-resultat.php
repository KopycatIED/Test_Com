    ...
    <body>
        ...
        <section>
                ...
                <div>
                    ...
                    <div><img src="IED/image/orly_ouest_low.jpg" alt="Hall 2 aérogare Ouest"/> </div>
                </div>
        ...
        if(isset($_POST['submit'])) //Determine si une variable est définie et est non NULL
        {
            $data_missing = array(); // Tableau d'affichage des valeurs non remplie
                ...
                <form method="post" action="http://localhost/chap5-d3-resultat.php" style="background-color:aqua">
                    <h3>Exercice formulaire Mysql - PHP</h3>
                        <p>Entrer vos coordonnées</p>
                       <table border="0">
                        <tr>
                            <td>Prénom :</td>
                            <td align= "center"><input type="text" name="prenom" size="30"/></td>
                        </tr>
                        <tr>
                            <td>Nom :</td>
                            <td align= "center"><input type="text" name="nom" size="30"/></td>                     
                        </tr>
                        <tr>
                            <td>Adresse mail :</td>
